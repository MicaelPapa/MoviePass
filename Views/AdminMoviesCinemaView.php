...
<div id="box" class="container" style="background-color: rgba(255, 255, 255, 0.5);">
  <div class="row" class="form-inline">
    <div class="col-md-4">
      <form id="searchBox" action="<?php echo FRONT_ROOT ?> Movies/ShowMoviesCinema" method="POST">
        <div class="form-row justify-content-center">
          <div class="form-group col-md-6">
            <div class="input-group mb-3">
              ...
              <input type="hidden" name="idCinema" value = "" />
            </div>
          </div>
        </div>
      </form>
    ...
    <div class="col-md-4">
      <form id="selectGenre" action="<?php echo FRONT_ROOT ?>Movies/ShowMoviesCinema" method="POST">
        <div class="form-row justify-content-center">
    ...
    <div class="col-md-4">
      <form id="dateMovie" action="<?php echo FRONT_ROOT ?>Movies/ShowMoviesCinema" method="POST">
        <div class="form-row justify-content-center">
          <div class="form-group col-md-12">
            <input type="hidden" name="alertMessage" value="" />
            <input type="hidden" name="alertType" value="" />
            ...
            <button type="submit" class="btn btn-success" id="submitDate" name="idCinema" value=""><i class="fas fa-search"></i></button>
          </div>
        </div>
      </form>
    </div>
          ...
          <div class="flip-card-inner">
            ...
            <div class="flip-card-back">
              ...
              <p><?php echo $movie->getReleaseDate(); ?></p>
                ...
                <p><a id="addMovie" href="<?php echo FRONT_ROOT ?>Movies/AddMovieToDatabase?IdMovieIMDB=<?php echo $movie->getIdMovieIMDB(); ?>"><button id="add" class="button">Agregar Pelicula</button></a></p>
